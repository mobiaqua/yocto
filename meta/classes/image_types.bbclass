...
# MobiAqua: added owner and group to tar
IMAGE_CMD_tar = "${IMAGE_CMD_TAR} --sort=name --format=posix --owner 0 --group 0 --numeric-owner -cf ${IMGDEPLOYDIR}/${IMAGE_NAME}${IMAGE_NAME_SUFFIX}.tar -C ${IMAGE_ROOTFS} . || [ $? -eq 1 ]"
