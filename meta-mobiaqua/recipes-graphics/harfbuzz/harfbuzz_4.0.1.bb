...
# MobiAqua:
FILESEXTRAPATHS:prepend := "${THISDIR}/../../../meta/recipes-graphics/harfbuzz/${PN}:"
...
# MobiAqua: removed 'gtk-doc gobject-introspection'
...
# MobiAqua: removed "cairo glib graphite icu"
...
PACKAGES =+ "${PN}-subset icu icu-dev"
