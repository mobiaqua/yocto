...
# MobiAqua: removed 'libcap'
DEPENDS = "libevent util-linux sqlite3 libtirpc"
RDEPENDS:${PN} = "${PN}-client"
RRECOMMENDS:${PN} = "kernel-module-nfsd"

# MobiAqua:
FILESEXTRAPATHS:prepend := "${THISDIR}/../../../meta/recipes-connectivity/nfs-utils/${PN}:"
...
SRC_URI = "${KERNELORG_MIRROR}/linux/utils/nfs-utils/${PV}/nfs-utils-${PV}.tar.xz \
           ...
           file://fix-rpcgen.patch \
           file://avoid-ipv6.patch \
           "
...
# MobiAqua: changed from 'rpcuser' to 'nobody'. added '--with-rpcgen=internal', '--disable-ipv6'
...
# MobiAqua: ignore check for runtime python3 depedency
...
do_install:append () {
	...
	# MobiAqua: disabled python tools
