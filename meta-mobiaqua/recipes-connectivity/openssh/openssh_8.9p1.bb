...
# MobiAqua: yocto bug? "0001-Default-..." and "f10746717..."  must be placed here
FILESEXTRAPATHS:prepend := "${THISDIR}/../../../meta/recipes-connectivity/openssh/${PN}:"
...
inherit manpages update-rc.d update-alternatives systemd
