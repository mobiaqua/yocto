...
SRCREV = "f94669f560268679108c47261016fa9f287c6bac"

BUILD_TYPE = "release"

MAKE_TARGETS = "-C eurasiacon/build/linux2/omap_linux BUILD=${BUILD_TYPE} TARGET_PRODUCT=ti443x KERNELDIR=${STAGING_KERNEL_DIR}"

do_install() {
	mkdir -p ${D}/lib/modules/${KERNEL_VERSION}/kernel/drivers/gpu/pvr
	cp ${S}/eurasiacon/binary2_omap_linux_${BUILD_TYPE}/target_armhf/kbuild/omapdrm_pvr_ti443x.ko ${D}/lib/modules/${KERNEL_VERSION}/kernel/drivers/gpu/pvr
}
