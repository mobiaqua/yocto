...
INSTALL_PKGS += "u-boot-pandaboard u-boot-beagleboard sgx-module-init sgx-pvrsrvinit \
                 sgx-pvr-gbm sgx-module-panda sgx-module-beagle gles-dummy \
                 libdce libdce-firmware wl127x-fw abefw vpdma-fw libavcodec libavformat \
                 libavutil libavresample libswscale libswresample wireless-regdb-static \
"
