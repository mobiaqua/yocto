...
inherit autotools binconfig-disabled pkgconfig native
...
do_install() {
        ...
        oe_runmake -C narrowc ${_install_cfgs} ${_install_opts} install.progs
        ...
        oe_runmake -C narrowc ${_install_cfgs} install.data
