...
PE = "1"
SRCREV = "9fc611e38004b1ddaa6668297408649ed556c157"

S = "${WORKDIR}/git"

DEPENDS = "lua-native file-replacement-native popt-native openssl-native gettext-native zstd-native xz-native"

inherit autotools gettext pkgconfig native
...
EXTRA_OECONF:append = " --with-crypto=openssl --disable-openmp --with-vendor=pc --enable-shared=no"

LDFLAGS:append = " -lz -llz -lzstd -llzma -liconv"
...
EXTRA_OECONF:append = " --sysconfdir=/etc --disable-plugins"

PACKAGECONFIG ??= "sqlite zstd"
